...
function renderSidebar(activePage) {
  ...
  const adminNav = isAdmin ? [
    ...
    { href: '/admin/discord',        icon: ICONS.discord,  label: 'Discord',        key: 'admin-discord-status' },

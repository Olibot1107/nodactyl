...
const PUBLIC_KEYS = ['panel_name', 'panel_logo', 'discord_enabled', 'github_enabled', 'totp_enabled', 'passkeys_enabled', 'qr_login_enabled', 'api_enabled', 'pwa_enabled', 'pwa_installable'];
